...
$result = $bdd->prepare('SELECT * FROM humidity ORDER BY data_date ASC');
$result->execute();
if (isset($_GET['date']))
{
      $date = $_GET['date'];
...
<?php require 'inc/header.php'; ?>
    ...
    <form class="container" id="needs-validation" novalidate>
      <p class="h3 font-weight-bold">Graphique humidité</p>
      <div class="row">
   ...
   <div id="line_chart" style="width: 100%; height: 480px"></div>
           ...
           <div class="container">  
              <p class="h3 font-weight-bold">Tableau humidité</p>
                <br></br>
