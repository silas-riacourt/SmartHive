...
<a class="navbar-brand" href="#">SmartHive</a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <?php else: ?>
              <li><a href="index.php"><span class="glyphicon glyphicon-user"></span> S'inscrire</a></li>
              <li><a href="index.php"><span class="glyphicon glyphicon-log-in"></span> Se connecter</a></li>
             <?php endif; ?>
            </ul>
        </div>
      </div>
...
<li>
<a href=""><span><img alt="" class="sidebar-icon" src="images/final.png" /> Tableaux</span></a>
</li>
<li>
<a href=""><span><img alt="" class="sidebar-icon" src="images/final.png" /> Graphique</span></a>
</li>
</ul>
</li>
<li class="nav-divider"></li>
...
<ul class="nav  tree active-trial">
<li>
<a href=""><span><img alt="* " class="sidebar-icon" src="images/final.png" /> Température</span></a>
</li>
<li>
<a href=""><span><img alt="* " class="sidebar-icon" src="images/final.png" /> Nombre d&#39;abeilles</span></a>
</li>
<li>
<a href=""><span><img alt="* " class="sidebar-icon" src="images/final.png" /> Humidité</span></a>
</li>
</ul>
</li>
<li class="nav-divider"></li>
    ...
    <?php if(isset($_SESSION['flash'])): ?>
      <?php foreach($_SESSION['flash'] as $type => $message):?>
       <center><div class="alert alert-<?= $type; ?>">
          <?= $message; ?>
        </div></center>
      <?php endforeach; ?>
